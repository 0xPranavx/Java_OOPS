...
public class TcsJavaHackathon {
    ...
    public static void main(String[] args ) {
        ...
        for(int a = 0 ; a<numberOfBookObj ; a++){
            ...
            bookObj.add(new Book(bookId , title , genre ,price ,authorObj));
        }
        ...
        for(int y = 0 ; y <genreObjAns.size(); y++){
            if(genreObjAns.size() != 0){
                System.out.println("AuthorName:"+ genreObjAns.get(y).getAuthor().getAuthorName() + ", Title:" + genreObjAns.get(y).getTitle() );
            }
            else{
        ...
        for(int z= 0 ; z < discountAns.size() ; z++){
            if(discountAns.size() != 0 ){
                ...
                System.out.println("AuthorName:"+ discountAns.get(z).getAuthor().getAuthorName() + ", Title:" + discountAns.get(z).getTitle() + ", Updated Price:" + discountAns.get(z).getPrice()  );
            }
            else{
